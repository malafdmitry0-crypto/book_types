...
Не все возможности современного Go доступны в одной и той же версии компилятора. У каждого примера ниже есть минимальная версия; новые файлы кода отделены условиями сборки.
